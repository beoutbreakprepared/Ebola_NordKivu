...
ug_infect$sr_50_new <- 1


health_areas <- bind(health_areas, ug_infect, ariwara_zone)
ha_infect <- health_areas[which(health_areas@data$sr_50_new == 1),]
...
writeRaster(access.raster, filename = 'Outputs_SR50/access_raster_raw.tif', overwrite = TRUE)
...
writeRaster(access.raster, filename = 'Outputs_SR50/access_raster_hours.tif', overwrite = TRUE)
...
# To save plots use
ggsave(trav_time_plot, filename = 'Outputs_SR50/Travel_time_map.png', width = 8, height = 8)
ggsave(rw_plot, filename = 'Outputs_SR50/Rwanda_map.png', width = 8, height = 8)
ggsave(ug_plot, filename = 'Outputs_SR50/Uganda_map.png', width = 8, height = 8)
ggsave(sd_plot, filename = 'Outputs_SR50/SSudan_map.png', width = 8, height = 8)
...
# Save to csv
write.csv(hospitals, file = file('Outputs_SR50/hospital_tt.csv', encoding = 'UTF-8'))
write.csv(drc_hosp_tt, file = file('Outputs_SR50/drc_hosp_tt.csv', encoding = 'UTF-8'))
write.csv(rw_hosp_tt, file = file('Outputs_SR50/rw_hosp_tt.csv', encoding = 'UTF-8'))
write.csv(ug_hosp_tt, file = file('Outputs_SR50/ug_hosp_tt.csv', encoding = 'UTF-8'))
write.csv(ss_hosp_tt, file = file('Outputs_SR50/ss_hosp_tt.csv', encoding = 'UTF-8'))
...
ggsave(drc_tab, filename = 'Outputs_SR50/drc_hosp_tt_prettytab.png', height = 8, width = 4)
ggsave(rw_tab, filename = 'Outputs_SR50/rw_hosp_tt_prettytab.png', height = 8, width = 4)
ggsave(ug_tab, filename = 'Outputs_SR50/ug_hosp_tt_prettytab.png', height = 8, width = 4)
ggsave(ss_tab, filename = 'Outputs_SR50/ss_hosp_tt_prettytab.png', height = 8, width = 4)
